...
The available frontend nodes are `fend01`, `fend02`, and `fend05` — you can use any of them. Frontend nodes are shared, so use them only for editing files, submitting jobs, and light tasks — not for running computations.
